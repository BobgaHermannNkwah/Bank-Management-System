...
namespace Bank_Management_System.dbloginDataSetTableAdapters {
    ...
    public partial class LoginTblTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LoginTbl] WHERE (([Id] = @Original_Id) AND ((@IsNull_Username " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[LoginTbl] ([Username], [Password]) VALUES (@Username, @Passwor" +
                "d);\r\nSELECT Id, Username, Password FROM LoginTbl WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LoginTbl] SET [Username] = @Username, [Password] = @Password WHERE (([Id] = @Original_Id) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT Id, Username, Password FROM LoginTbl WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Bank_Management_System.Properties.Settings.Default.dbloginConnectionString;
        }
        ...
        public virtual int Fill(dbloginDataSet.LoginTblDataTable dataTable) {
        ...
        public virtual dbloginDataSet.LoginTblDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbloginDataSet.LoginTblDataTable dataTable = new dbloginDataSet.LoginTblDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbloginDataSet.LoginTblDataTable dataTable) {
